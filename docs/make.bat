...
REM This file exists within 'pep440-version-compare-cli':
REM
REM   https://github.com/hotoffthehamster/pep440-version-compare-cli

set PROJECTNAME=pep440-version-compare-cli
